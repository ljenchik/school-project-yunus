...
int main() 

 {
  ...
  available_subjects->allocated_count = 10;
  
   available_subjects->current_subject_list[0] = malloc(sizeof(Subject));
   Subject *new_subject1 = createSubject();
 
   available_subjects->current_subject_list[1] = malloc(sizeof(Subject));
   Subject *new_subject2 = createSubject();

   available_subjects->current_subject_list[2] = malloc(sizeof(Subject));
